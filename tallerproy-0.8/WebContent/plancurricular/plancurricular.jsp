...
<tr>
<th class="" style="" colspan="16"><h3> Plan Curricular </h3></th>
</tr>
...
<% 
	...
	<tr>
		<td class="td"><%=VECTOR_LIST.get(i).getCurso_id()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getCurso_nombre()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getCreditos()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getCiclo()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getCiclo_id()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getHorasTeoria()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getHorasLaboratorio()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getHorasPractica()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getCreditos_requisito()%></td>
		<td class="td"><%=VECTOR_LIST.get(i).getCurso_condicion_id()%></td>
	</tr>
...
<input type="submit" name="btn_funcion" value="Elegir Plan"/>
<input type="submit" name="btn_funcion" value="Modificar Plan"/>
</form>
